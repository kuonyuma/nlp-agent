...
def validate_artifact_origin(origin: str, *, application_origin: str) -> str:
    ...
    if (parsed_origin.scheme, parsed_origin.netloc) == (
        parsed_application.scheme,
        parsed_application.netloc,
    ):
...
def artifact_security_headers(mime_type: str) -> dict[str, str]:
    ...
    csp = "default-src 'none'; script-src 'none'; connect-src 'none'; object-src 'none'; base-uri 'none'; form-action 'none'; img-src data: blob:; style-src 'unsafe-inline'; frame-ancestors 'none'; sandbox"
